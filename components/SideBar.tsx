      ...
      {showSidebar && (
        <div className="fixed inset-0 z-50 flex">
          ...
          >
            ...
            <button className="bg-white mb-[30px] w-[236px] text-[#009CA9] text-[17px] font-semibold px-4 py-[17px] rounded-[10px] shadow">
              Каркасные бассейны
            </button>

            <button className="bg-white mb-[216px] w-[236px] text-[#009CA9] text-[17px] font-semibold px-4 py-[17px] rounded-[10px] shadow">
              Надувные бассейны
            </button>

            <a href={`tel:${siteData?.phone}`}><button className="bg-[#139D4B] mb-[20px] h-[56px] w-[236px] text-[#fff] text-[21px] font-semibold px-4 py-[17px] rounded-[10px] shadow flex items-center justify-center gap-2">
              <svg
                width="25"
                height="25"
                viewBox="0 0 25 25"
            ...
            <a target="_blank" href={`${siteData?.instagramLink}`}><button className="bg-[#fff] flex justify-center items-center gap-2 h-[56px] w-[236px] text-[#009CA9] text-[21px] font-semibold px-4 py-[17px] rounded-[10px] shadow">
              <Image alt="Instagram Icon" src="/instagramIcon.png" width={40} height={40} />
              Инстаграм
            </button></a>
          </div>
